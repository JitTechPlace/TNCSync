...
//                    db.tblVendorCreit_Insert(VendorRef_Key, vendorName, APAccountRef_Key, (decimal?)Amount, (decimal?)amountInHC, currencyRef, EditSequence.ToString(), exchangeRate, Memo, (decimal?)openAmount, TxnDate, TxnNumber.ToString(), type, ClearAllControl.gblCompanyID, RefNumber);
...
//                    db.tblBill_Insert(ClearAllControl.gblCompanyID, TxnID, TimeCreated, TimeModified, EditSequence, TxnNumber, Conversions.ToChar(CR_Flag), VendorRef_Key, APAccountRef_Key, TxnDate, DueDate, (decimal?)Amount, (decimal?)AmountDue, RefNumber, TermsRef_Key, Memo, BillNo, Bill_Source);
